...
const Card: React.FC<Props> = ({ id, searchResult, onBookshelfCreate }: Props) : JSX.Element => {
    return (
        <div className="flex flex-col w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl h-[900px] m-5">
            ...
            <div className="px-4 py-3 w-75">
                ...
                <br />
                <hr />
                <p className="max-h-[220px] overflow-auto">{searchResult.synopsis}</p>
                <hr />   
            </div>
